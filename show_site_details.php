...
<html lang="en">
	...
	<body>
		<header>
		  <hgroup>
			<h1 id="SiteName">Load from json file</h1>
			<h3 id="SiteAddress">Load from json file</h3>
		  </hgroup>
		...
		<section>
			...
			<?php
				...
				$query = "SELECT path, picture_name, picture_desc, siteid, main FROM caravansites.sitepictures where siteid=".$siteindex." and main='T'";
				...
				if ($response) {
					...
					echo " Picture_path = ".$picture_path;
			...
			<div id="tabs">
				...
				<div id="tabsGeneral">
					...
					<div class="container">
						<figure id="mainPic">
							<a href="#tabsPictures">	<img src="<?= $picture_path.$picture_name ?>"" alt="A picture of our caravan site"></a>
				...
				<div id="tabsPictures">
					...
					<?php
						// Create a query for the database.  Get the main picture for the site.
						$query = "SELECT path, picture_name, picture_desc, siteid, main FROM caravansites.sitepictures where siteid=".$siteindex." and main='F'";
						// Get a response from the database by sending the connection and the query
						$response = @mysqli_query($dbc, $query);
						if (!$response) {
